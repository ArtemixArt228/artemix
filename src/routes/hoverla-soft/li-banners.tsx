...
function LiBanners() {
  return (
    <div className="min-h-screen bg-[#0a0a0c] text-[#f1f1f3] font-sans">
      <header className="mx-auto max-w-410 px-12 pt-14 pb-6">
        <h1 className="mb-2 text-2xl font-semibold tracking-tight">
          Hoverla<span className="text-[#C8E548]">/</span>Soft — LinkedIn banner concepts
        </h1>
        <p className="max-w-205 text-base leading-relaxed text-[#8e8e96]">
      ...
      <main className="mx-auto grid max-w-410 gap-14 px-12 pb-24">
        {banners.map((banner, i) => (
          <section
            key={banner.slug}
            className="overflow-hidden rounded-2xl border border-[#1f1f25] bg-[#111114]"
          >
            <div className="flex flex-wrap items-baseline justify-between gap-4 border-b border-[#1f1f25] px-6 py-4.5">
              ...
              <div className="min-w-70 flex-1 text-sm text-[#8e8e96]">{banner.desc}</div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2 border-t border-[#1f1f25] px-6 py-3.5 text-sm text-[#8e8e96]">
              <span>1584 × 396</span>
              <a
                href={`${ASSET_BASE}/${banner.slug}.png`}
                download
                className="rounded-full border border-[#1f1f25] px-3 py-1.5 text-xs tracking-[1px] text-[#f1f1f3] no-underline transition-colors hover:border-[#C8E548] hover:text-[#C8E548]"
              >
                Download PNG
              </a>
              <a
      ...
      <footer className="mx-auto max-w-410 px-12 pb-16 text-sm leading-relaxed text-[#8e8e96]">
        <p>
