					...
					return (
						...
						>
							...
							<AccordionTrigger className="grid grid-cols-[60px_1.6fr_1fr_130px_40px] items-baseline gap-6 py-7 hover:no-underline max-[960px]:grid-cols-[40px_1fr_auto_24px] max-[560px]:grid-cols-[30px_1fr_28px]">
								...
								<div className="font-cond text-[clamp(28px,3.2vw,40px)] uppercase leading-none tracking-[-0.03em] text-white transition-transform duration-[400ms] ease-[cubic-bezier(0.2,0.7,0.1,1)] group-hover:translate-x-2">
									{w.company}
								</div>
								...
								<div className="grid grid-cols-[1.4fr_1fr] gap-8 pb-7 max-[960px]:grid-cols-1">
									...
									<div className="flex flex-wrap content-start gap-1.5">
										{w.stack.map((s) => (
											<Badge
												key={s}
												className="h-auto whitespace-nowrap rounded-pill border-white/20 bg-transparent px-2.5 py-1.5 font-mono text-[11px] tracking-[-0.22px] text-ash"
											>
												{s}
											</Badge>
										))}
